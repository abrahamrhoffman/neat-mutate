...
The primary benefit of using this NeuroEvolution library is that it distributes either your dynamic graphs (models) to N number of nodes. This is a critical feature as it allows dense problem spaces to be traversed quickly. To find out more, please read here:
- Minimizing Dimensionality: https://goo.gl/vtU63o

## Installation
- Work is being done to get all dependencies pushed to PyPi.
